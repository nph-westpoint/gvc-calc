...
# How to run this App
There are two alternatives to running this app provided for the user. There is a zero-download option that is run on the Streamlit servers, and a second option using a Dockerfile
## Method 1 (No downloads)
...
2) Windows:Use the [![Download](https://img.shields.io/badge/windows-download-red)](https://github.com/nph-westpoint/gvc-calc/blob/main/run_options/Run_App.bat?inline=false)
3) Mac: Use the [![Download](https://img.shields.io/badge/MAC-download-blue)]([run_options/Run_App.command](https://github.com/nph-westpoint/gvc-calc/blob/main/run_options/Run_App.bat)?inline=false)
