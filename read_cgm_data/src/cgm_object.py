...
from ..functions import (time_in_range,glucose_N,glucose_mean,
                        ...
                        glycemic_risk_index,auc,auc_thresh,auc_thresh_rate,
...
class CGM(object):
    ...
    def assign_functions(self):
        ...
        self.stats_functions['total_time']['time_agg'] = []
        ...
        self.stats_functions['total_days']['time_agg'] = ['all','date','period','day']
        ...
        self.stats_functions['li']['type'] = ['paper','rGV']
        ...
        self.stats_functions['auc_rate_100']={}
        self.stats_functions['auc_rate_100']['f']=auc_thresh_rate
        self.stats_functions['auc_rate_100']['description']='AUC_100'
        self.stats_functions['auc_rate_100']['normal'] = []
        self.stats_functions['auc_rate_100']['time_agg'] = ['all','date','period','day']
        self.stats_functions['auc_rate_100']['levels'] = ['auc_rate']
...
1 	    25.82490 	    12.47077 	    13.35413 	        29.83252 	        14.25410 	    15.57842
    ...
    def poincare_plot(self,shift_minutes = 5):
        ...
        major = (5,25)
        minor = (5,5)
        xlabel = r"glucose $CGM(t_{i-1})$ mg/dL"
        ylabel = r"glucose $CGM(t_{i})$ mg/dL"
        if self.units == 'mmol':
            plim = [p/18.018 for p in plim]
            major = [m/18.018 for m in major]
            minor = [m/18.018 for m in minor]
            xlabel = r"glucose $CGM(t_{i-1})$ mmol/L"
            ylabel = r"glucose $CGM(t_{i})$ mmol/L"
